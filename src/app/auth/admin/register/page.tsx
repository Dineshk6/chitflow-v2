      ...
      <div className="hidden md:flex md:w-1/2 bg-slate-900 p-12 flex-col justify-between text-white relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="text-slate-400 text-lg max-w-md leading-relaxed">
            Create an agent account to start managing groups, automating collections, and growing your chit fund business.
          </p>
        </div>

        <div className="relative z-10">
          <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
            <h4 className="font-bold mb-2">Agent Account Includes:</h4>
      ...
      <div className="flex-1 flex items-center justify-center p-8 md:p-20 bg-white dark:bg-slate-950">
        <div className="w-full max-w-md space-y-10">
          <div>
            ...
            <h1 className="text-3xl font-black text-slate-900 dark:text-white mb-2">Agent Registration</h1>
            <p className="text-slate-500 dark:text-slate-400 font-medium">Create your agent workspace.</p>
          </div>
          ...
          <p className="text-center text-sm font-medium text-slate-500 dark:text-slate-400">
            Already have an agent account? <Link href="/auth/admin/login" className="text-slate-900 dark:text-white font-bold hover:underline">Log in</Link>
          </p>
        </div>
      </div>
    </div>
